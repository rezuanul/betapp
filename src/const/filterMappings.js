export const categoryOptions = [
    ...
    { value: 6, label: 'E-sports' },
    { value: 7, label: 'Entertainment' },
    { value: 8, label: 'Football' },
    { value: 9, label: 'Formula 1' },
    { value: 10, label: 'Gymnastics' },
    { value: 11, label: 'Golf' },
    { value: 12, label: 'Ice Hockey' },
    { value: 13, label: 'Politics' },
    { value: 14, label: 'Riding' },
    { value: 15, label: 'Sailing' },
    { value: 16, label: 'Skiing' },
    { value: 17, label: 'Shooting' },
...
export const countryOptions = [
    ...
    { value: 39, label: 'Congo (Democratic Republic)' },
    ...
    { value: 89, label: 'North Korea' },
    { value: 90, label: 'South Korea' },
    ...
    { value: 196, label: 'International' },
    { value: 197, label: 'Europe' },
    { value: 198, label: 'North America' },
    { value: 199, label: 'South America' },
